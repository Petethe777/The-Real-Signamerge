        ...
        <div className="space-y-6 text-sm text-gray-600 leading-relaxed">
          ...
          <div className="p-5 bg-amber-50 border border-amber-100 rounded-2xl">
            ...
            <div className="mt-3 space-y-2 text-[11px] text-amber-800/80">
              ...
              <p>4.3 <strong>Simulated, Preview & Sandbox Data Representation Clause:</strong> The Platform contains active demonstration portals, developer/administrative sandboxes, partner staging dashboards, and interactive mock-ups representing simulated feed activities, live-stream queries, and user actions. The Client expressly acknowledges that simulated and preview environments are created strictly for presentation, structural, visual alignment, and educational preview purposes. Consequently: (a) simulated data, statistics, timestamps, and usernames do not depict real-world interactions, active live signals, or actionable prospects unless verified and retrieved from a connected live enterprise application database; (b) the Company (Mergemega) completely disclaims any liability, direct or indirect, for any business decisions, interpretations, biases, or perceptions formed by the Client, its managers, representatives, or external audiences regarding simulated and preview data; and (c) the Client accepts all risks associated with how simulated information is displayed, perceived, or utilized, waiving any claims against Mergemega in connection thereto.</p>
            </div>
          </div>
