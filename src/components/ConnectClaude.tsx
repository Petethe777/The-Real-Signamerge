...
export default function ConnectClaude() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFDFD] text-[#1A1A1A] font-sans selection:bg-orange-100 selection:text-orange-600">
      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-orange-100 px-6 sm:px-12 py-4 shadow-sm">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3 text-sm font-black uppercase text-gray-500 hover:text-primary transition-colors">
      ...
      <main className="max-w-5xl mx-auto px-6 py-12 space-y-16">
        ...
        <section className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <h1 className="text-4xl sm:text-5xl font-black text-[#111] tracking-tight leading-tight">
        ...
        <Card className="border-orange-100 shadow-xl shadow-orange-500/5 bg-gradient-to-br from-white to-orange-50/20 overflow-hidden rounded-[2.5rem]">
          <CardContent className="p-8 sm:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="space-y-3 max-w-lg">
              <span className="text-[10px] font-black uppercase tracking-widest text-primary">Your Unique SSE Endpoint URL</span>
              <h2 className="text-xl font-black text-[#111] tracking-tight">Personalized Connection URL</h2>
              <p className="text-xs text-gray-500 font-semibold leading-relaxed">
                Use this link when configuring your MCP client. It establishes a real-time Server-Sent Events (SSE) stream allowing any LLM to call Signalmerge's lead retrieval tools.
              </p>
            </div>
            
            <div className="w-full md:w-auto shrink-0 flex flex-col sm:flex-row items-stretch sm:items-center bg-white border border-orange-100/80 p-2 rounded-2xl gap-2 shadow-sm">
              <code className="px-4 py-3 bg-gray-50 text-xs text-gray-700 rounded-xl font-mono truncate max-w-[320px] select-all">
                {serverUrl || "https://signalmerge.dev/sse"}
              </code>
              <Button 
                onClick={() => handleCopy(serverUrl, "url")}
                className="bg-primary hover:bg-orange-600 text-white font-bold rounded-xl px-5 py-5 text-xs uppercase shrink-0 gap-1.5"
              >
                {copiedText === "url" ? (
        ...
        <section className="space-y-8">
          <div className="flex flex-col items-center justify-center gap-4 text-center">
            <h2 className="text-2xl font-black text-[#111] tracking-tight">Choose Your Setup Method</h2>
            <p className="text-sm text-gray-500 font-medium">Select whether you want to connect Claude on your desktop or directly on the Claude website.</p>
            
            {/* Interactive Switch */}
            <div className="flex bg-gray-100 p-1.5 rounded-2xl border border-gray-200/50 mt-2">
              <button
              ...
              >
                <Laptop className="w-4 h-4" /> Claude Desktop App
              </button>
              <button
              ...
              >
                <Globe className="w-4 h-4" /> Claude Website (Claude.ai)
              </button>
            </div>
          </div>
              ...
              >
                ...
                <div className="md:col-span-7 space-y-6">
                  <div className="bg-white border border-gray-100 p-6 rounded-[2rem] shadow-sm space-y-4">
                    <div className="flex items-center gap-3">
                      <div className="w-7 h-7 rounded-lg bg-orange-50 flex items-center justify-center font-black text-xs text-primary">1</div>
                      <h3 className="font-black text-base text-[#111] uppercase tracking-tight">Open configuration folder</h3>
                    </div>
                    ...
                    <div className="pl-10 space-y-3">
                      <div className="bg-gray-50 border border-gray-100 rounded-xl p-3 text-xs flex justify-between items-center">
                        <div className="space-y-1">
                          ...
                          <code className="block font-mono text-gray-700 select-all">%APPDATA%\\Claude\\claude_desktop_config.json</code>
                        </div>
                        <Button variant="ghost" size="icon" className="h-8 w-8 hover:bg-gray-100 text-gray-400 hover:text-primary" onClick={() => handleCopy("%APPDATA%\\Claude\\claude_desktop_config.json", "win_path")}>
                      ...
                      <div className="bg-gray-50 border border-gray-100 rounded-xl p-3 text-xs flex justify-between items-center">
                        <div className="space-y-1">
                          ...
                          <code className="block font-mono text-gray-700 select-all">~/Library/Application Support/Claude/claude_desktop_config.json</code>
                        </div>
                        <Button variant="ghost" size="icon" className="h-8 w-8 hover:bg-gray-100 text-gray-400 hover:text-primary" onClick={() => handleCopy("~/Library/Application Support/Claude/claude_desktop_config.json", "mac_path")}>
                  ...
                  <div className="bg-white border border-gray-100 p-6 rounded-[2rem] shadow-sm space-y-4">
                    <div className="flex items-center gap-3">
                      <div className="w-7 h-7 rounded-lg bg-orange-50 flex items-center justify-center font-black text-xs text-primary">2</div>
                      <h3 className="font-black text-base text-[#111] uppercase tracking-tight">Paste the Configuration</h3>
                    </div>
                    <p className="text-xs text-gray-500 font-medium leading-relaxed pl-10">
                  ...
                  <div className="bg-white border border-gray-100 p-6 rounded-[2rem] shadow-sm space-y-4">
                    <div className="flex items-center gap-3">
                      <div className="w-7 h-7 rounded-lg bg-orange-50 flex items-center justify-center font-black text-xs text-primary">3</div>
                      <h3 className="font-black text-base text-[#111] uppercase tracking-tight">Relaunch Claude App</h3>
                    </div>
                    <p className="text-xs text-gray-500 font-medium leading-relaxed pl-10">
                ...
                <div className="md:col-span-5 space-y-4">
                  <div className="bg-[#111] text-white p-6 rounded-[2rem] shadow-lg relative overflow-hidden group">
                    <div className="flex justify-between items-center mb-4">
                      <span className="text-[9px] font-black text-gray-400 uppercase tracking-widest flex items-center gap-1.5">
                        <Terminal className="w-3.5 h-3.5 text-primary" /> claude_desktop_config.json
                      </span>
                      <Button 
                  ...
                  <div className="bg-orange-50/50 border border-orange-100/60 p-5 rounded-[2rem] text-xs font-semibold text-gray-650 leading-relaxed space-y-2">
                    <p className="font-black text-primary uppercase text-[9px] tracking-wider flex items-center gap-1">
                      <ShieldCheck className="w-4 h-4 text-primary" /> Tech Note:
                    </p>
                    <p>
              ...
              >
                ...
                <div className="md:col-span-7 space-y-6">
                  <div className="bg-white border border-gray-100 p-6 rounded-[2rem] shadow-sm space-y-4">
                    <div className="flex items-center gap-3">
                      <div className="w-7 h-7 rounded-lg bg-orange-50 flex items-center justify-center font-black text-xs text-primary">1</div>
                      <h3 className="font-black text-base text-[#111] uppercase tracking-tight">Install a browser extension</h3>
                    </div>
                    <p className="text-xs text-gray-500 font-medium leading-relaxed pl-10">
                    ...
                    <div className="pl-10 pt-2">
                      <a 
                        ...
                        className="inline-flex items-center gap-2 rounded-xl bg-gray-100 hover:bg-gray-250 text-gray-700 hover:text-[#111] px-5 py-3 text-xs font-black uppercase tracking-wider transition-all border border-gray-200"
                      >
                  ...
                  <div className="bg-white border border-gray-100 p-6 rounded-[2rem] shadow-sm space-y-4">
                    <div className="flex items-center gap-3">
                      <div className="w-7 h-7 rounded-lg bg-orange-50 flex items-center justify-center font-black text-xs text-primary">2</div>
                      <h3 className="font-black text-base text-[#111] uppercase tracking-tight">Add Your Server Connection</h3>
                    </div>
                    <p className="text-xs text-gray-500 font-medium leading-relaxed pl-10">
                      Click the extension's icon in your browser toolbar, select <strong>Add Server</strong>, and fill in these values:
                    </p>
                    <div className="pl-10 space-y-3">
                      <div className="grid grid-cols-3 gap-2 bg-gray-50 border border-gray-100 rounded-xl p-3 text-xs font-semibold text-gray-600">
                        <div className="col-span-1 text-gray-400 font-bold uppercase text-[9px] tracking-wider self-center">Server Name:</div>
                        <div className="col-span-2 font-black text-gray-800">Signalmerge</div>
                      </div>
                      <div className="grid grid-cols-3 gap-2 bg-gray-50 border border-gray-100 rounded-xl p-3 text-xs font-semibold text-gray-600">
                        <div className="col-span-1 text-gray-400 font-bold uppercase text-[9px] tracking-wider self-center">Connection Type:</div>
                        <div className="col-span-2 font-black text-gray-800">SSE (Server-Sent Events)</div>
                      </div>
                      <div className="grid grid-cols-3 gap-2 bg-gray-50 border border-gray-100 rounded-xl p-3 text-xs font-semibold text-gray-600">
                        <div className="col-span-1 text-gray-400 font-bold uppercase text-[9px] tracking-wider self-center font-mono">SSE URL:</div>
                        <div className="col-span-2 flex justify-between items-center">
                          <code className="text-gray-800 font-bold truncate max-w-[180px]">{serverUrl}</code>
                          <Button variant="ghost" size="icon" className="h-6 w-6" onClick={() => handleCopy(serverUrl, "sse_web")}>
                  ...
                  <div className="bg-white border border-gray-100 p-6 rounded-[2rem] shadow-sm space-y-4">
                    <div className="flex items-center gap-3">
                      <div className="w-7 h-7 rounded-lg bg-orange-50 flex items-center justify-center font-black text-xs text-primary">3</div>
                      <h3 className="font-black text-base text-[#111] uppercase tracking-tight">Open Claude.ai & Converse</h3>
                    </div>
                    <p className="text-xs text-gray-500 font-medium leading-relaxed pl-10">
                ...
                <div className="md:col-span-5 space-y-6">
                  <div className="bg-white border border-gray-100 p-8 rounded-[2.5rem] shadow-sm text-center space-y-6">
                    ...
                    <div className="border-t border-gray-100 pt-6 flex flex-col gap-3">
                      <div className="flex items-center gap-3 text-left">
                        ...
                        <span className="text-[11px] font-bold text-gray-600">Works on Chrome, Brave, and Edge</span>
                      </div>
                      <div className="flex items-center gap-3 text-left">
                        <CheckCircle2 className="w-5 h-5 text-green-500 shrink-0" />
                        <span className="text-[11px] font-bold text-gray-600">Zero Command Line or Terminal Required</span>
                      </div>
                      <div className="flex items-center gap-3 text-left">
                        <CheckCircle2 className="w-5 h-5 text-green-500 shrink-0" />
                        <span className="text-[11px] font-bold text-gray-600">Connect in less than 2 minutes</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <section className="space-y-6">
          <div className="space-y-2 text-center">
            ...
            <h2 className="text-2xl font-black text-[#111] tracking-tight">Available MCP Tools Documentation</h2>
            <p className="text-sm text-gray-500 font-medium">When connected, Claude gets access to these specific capabilities inside your chat sessions:</p>
          </div>
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-gray-100 bg-gray-50/50 text-[10px] font-black text-gray-400 uppercase tracking-widest">
                    ...
                    <th className="px-8 py-5">Arguments / Parameters</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-50">
                  <tr>
                    <td className="px-8 py-6 font-mono text-xs font-black text-primary">search_leads</td>
                    <td className="px-8 py-6 text-xs text-gray-600 font-semibold leading-relaxed">
                      Scrapes, filters, and searches social media platforms (Reddit, TikTok, X, LinkedIn) grounded with Google Search for active 2026 leads.
                    </td>
                  ...
                  <tr>
                    <td className="px-8 py-6 font-mono text-xs font-black text-primary">get_search_logs</td>
                    <td className="px-8 py-6 text-xs text-gray-600 font-semibold leading-relaxed">
                      Retrieves a chronological log of high-intent search requests made across the workspace.
                    </td>
                    <td className="px-8 py-6 text-xs font-mono text-gray-500">
                      {"{}"}
                    </td>
                  ...
                  <tr>
                    <td className="px-8 py-6 font-mono text-xs font-black text-primary">verify_audit</td>
                    <td className="px-8 py-6 text-xs text-gray-600 font-semibold leading-relaxed">
                      Verifies the company's enterprise status on the Digital Consulting Pros registry.
                    </td>
                    <td className="px-8 py-6 text-xs font-mono text-gray-500">
        ...
        <section className="bg-white border border-gray-100 rounded-[3rem] p-8 sm:p-12 shadow-xl shadow-orange-500/5 space-y-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-gray-100 pb-8">
            <div className="space-y-2">
              ...
              <h2 className="text-2xl font-black text-[#111] tracking-tight">MCP Tool Simulator</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="md:col-span-5 space-y-6 flex flex-col justify-between">
              <div className="space-y-5">
                ...
                {selectedTool === "search_leads" && (
                  <div className="space-y-2">
                    <label className="text-[10px] font-black text-gray-500 uppercase tracking-wider">Query Keywords</label>
                    <Input 
                      value={simQuery} 
                ...
                {selectedTool === "get_search_logs" && (
                  <div className="bg-gray-50 p-4 rounded-2xl border border-gray-150 text-center">
                    <p className="text-xs text-gray-400 font-semibold leading-relaxed">
                      No arguments required for this tool. It queries all historical queries executed in this environment.
                    </p>
                  </div>
                )}
              </div>
              ...
              <Button 
                ...
                disabled={simulating}
                className="w-full bg-primary hover:bg-orange-650 text-white font-black rounded-xl py-6 uppercase text-xs tracking-wider shadow-lg shadow-orange-500/10 mt-6 gap-2"
              >
                {simulating ? (
                  <>
                    <RefreshCw className="w-4 h-4 animate-spin" /> Simulating Tool Execution...
                  </>
                ) : (
                  <>
                    <Play className="w-4 h-4 fill-white" /> Run Tool Simulation
                  </>
                )}
              </Button>
            </div>
            ...
            <div className="md:col-span-7 bg-[#111] rounded-[2rem] p-6 text-white min-h-[300px] flex flex-col justify-between">
              <div className="space-y-4">
                <div className="flex justify-between items-center border-b border-white/5 pb-3">
                  ...
                  {simResult && (
                    <Button 
                      ...
                      variant="ghost" 
                      className="text-gray-400 hover:text-white hover:bg-white/5 h-7 rounded-lg text-[9px] font-black uppercase"
                    >
                ...
                <div className="font-mono text-xs text-gray-350 overflow-y-auto max-h-[250px] leading-relaxed select-all">
                  {simulating ? (
                    <div className="flex flex-col items-center justify-center py-12 gap-3 text-center">
                      ...
                      <p className="text-xs text-gray-400 font-medium animate-pulse">Request sent. Scanning global nodes...</p>
                    </div>
                  ) : simResult ? (
                    ...
                    <div className="py-12 text-center text-gray-500 flex flex-col items-center justify-center gap-2">
                      ...
                      <p className="text-[10px] text-gray-600 max-w-xs leading-relaxed">
                        Configure parameters on the left and click "Run Tool Simulation" to view output.
                      </p>
                    </div>
                  )}
                </div>
              ...
              <div className="border-t border-white/5 pt-4 text-[9px] font-bold text-gray-500 uppercase tracking-widest flex justify-between items-center">
                <span>Protocol version: 2026.04</span>
                <span className="text-primary flex items-center gap-1"><span className="w-1.5 h-1.5 rounded-full bg-primary animate-pulse" /> Live connection stream active</span>
              </div>
            </div>
          </div>
        </section>
      ...
      <footer className="max-w-6xl mx-auto px-12 py-12 border-t border-gray-100 flex justify-between items-center text-[11px] font-bold text-gray-400 uppercase tracking-widest mt-24">
